...
Config.CostMultiplier = 4.0

-- Configure the strings as you wish here.
Config.Strings = {
	ExitVehicle = "Fahrzeug verlassen zum tanken",
	EToRefuel = "Drücke ~g~E~w~ um dein Fahrzeug zu tanken",
	JerryCanEmpty = "Kanister ist leer",
	FullTank = "Tank ist voll",
	PurchaseJerryCan = "Drücke ~g~E~w~ um einen Kanister zu kaufen für ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Drücke ~g~E~w~ um Tanken abzubrechen",
	CancelFuelingJerryCan = "Press ~g~E~w~ um Tanken abzubrechen",
	NotEnoughCash = "Nicht genug Geld",
	RefillJerryCan = "Drücke ~g~E~w~ um den Kanister zu füllen für ",
	NotEnoughCashJerryCan = "Nicht genug Geld um Kanister zu füllen",
